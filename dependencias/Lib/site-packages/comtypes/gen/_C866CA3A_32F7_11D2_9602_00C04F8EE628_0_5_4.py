...
__all__ = [
    'ISpeechPhoneConverter', 'SRAORetainAudio', 'SPAR_Unknown',
    'SPAUDIOBUFFERINFO', 'SAFT48kHz8BitMono', 'DISPID_SVPause',
    'SPSHT_Unknown', 'SVF_Emphasis', 'Speech_Max_Pron_Length',
    'SPWT_PRONUNCIATION', 'SREAudioLevel',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRCEFalseRecognition',
    'SpeechPartOfSpeech', 'SFTInput', 'SpeechDataKeyLocation',
    'SpNotifyTranslator', 'DISPID_SpeechRecognizer',
    'SpeechRecognitionType', 'SAFT22kHz16BitMono',
    'DISPID_SRRAudioFormat', 'DISPID_SVEStreamEnd',
    'ISpPhoneticAlphabetConverter', 'SPAS_STOP', 'DISPID_SDKEnumKeys',
    'DISPID_SLAddPronunciation', 'SP_VISEME_7', 'ISpShortcut',
    'DISPID_SRRTStreamTime', 'SRSActiveAlways', 'DISPID_SPRuleId',
    'SPSHT_OTHER', 'IStream', 'DISPID_SRAudioInput',
    'SPFM_OPEN_READONLY', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRSAddSpecialTransition', 'SP_VISEME_17',
    'DISPID_SRCEAudioLevel',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPRECOCONTEXTSTATUS',
    'SLTUser', 'SPRECOSTATE', 'DISPID_SWFEBlockAlign',
    'DISPID_SGRsFindRule', 'SPVPRI_OVER', 'SPPS_Noun',
    'DISPID_SGRSTRule', 'DISPID_SRDisplayUI', 'SPLO_DYNAMIC',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRSSupportedLanguages', 'DISPID_SBSSeek',
    'SAFTExtendedAudioFormat', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SLWWord', 'SPRULE', 'SPAS_CLOSED', 'SREStateChange',
    'DISPID_SRCEAdaptation', 'SpeechAudioProperties',
    'DISPID_SDKEnumValues', 'SPCT_DICTATION', 'DISPID_SAStatus',
    'SPFM_OPEN_READWRITE', 'SPPS_RESERVED2', 'SpeechAudioState',
    'eLEXTYPE_VENDORLEXICON', 'SPBO_AHEAD',
    'DISPID_SRSetPropertyString', 'SP_VISEME_2',
    'DISPID_SVSInputSentenceLength', 'SPSSuppressWord',
    'DISPID_SpeechAudioBufferInfo', 'SSSPTRelativeToStart',
    'DISPID_SVSLastResult', 'SpeechDictationTopicSpelling',
    'SWTDeleted', 'DISPID_SASCurrentSeekPosition', 'SVP_0',
    'DISPID_SPRules_NewEnum', 'DISPID_SPPs_NewEnum',
    'tagSPTEXTSELECTIONINFO', 'SVSFIsXML', 'SPEI_RESERVED6',
    'DISPID_SPIEngineId', 'SpeechPropertyHighConfidenceThreshold',
    'SAFT24kHz8BitStereo', 'ISpeechLexicon', 'SVPOver',
    'SPPHRASEPROPERTY', 'DISPID_SpeechGrammarRuleState',
    'SpUnCompressedLexicon', 'SREBookmark', 'DISPID_SVResume',
    'ISpPhrase', 'SpeechTokenKeyAttributes', 'SREPhraseStart',
    'SVSFNLPMask', 'DISPID_SRCCreateGrammar', 'DISPID_SPIElements',
    'SPBINARYGRAMMAR', 'DISPID_SVEViseme',
    'DISPID_SVSInputWordPosition', 'DISPID_SRCEHypothesis',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SOTDisplayUI',
    'SpeechRecoEvents', 'DISPID_SVRate', 'SRAImport',
    'DISPID_SVVolume', 'SRSEDone', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPPFirstElement', 'DISPID_SOTsCount', 'ISpStream',
    'SAFT16kHz16BitMono', 'SPEI_SOUND_END', 'ISpRecoContext2',
    'eLEXTYPE_PRIVATE19', 'STSF_FlagCreate', 'ISpeechXMLRecoResult',
    'SVSFParseAutodetect', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRRTLength', 'SPEI_REQUEST_UI', 'DISPID_SpeechAudio',
    'DISPID_SpeechMemoryStream', 'SPRECORESULTTIMES',
    'SPGS_EXCLUSIVE', 'SpeechCategoryVoices',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRGCmdSetRuleIdState',
    'SPSFunction', 'SPPHRASERULE', 'DISPIDSPRG',
    'DISPID_SpeechPhraseInfo', 'SpShortcut', 'SPVPRI_NORMAL',
    'SpMMAudioOut', 'ISpeechMMSysAudio', 'SpeechTokenShellFolder',
    'SP_VISEME_3', 'ISpeechLexiconPronunciations',
    'SPINTERFERENCE_NOISE', 'ISpeechFileStream', 'SDTRule',
    'DISPID_SpeechObjectTokenCategory', 'SpeechVoiceSpeakFlags',
    'SPRS_ACTIVE', 'SpResourceManager', 'SVSFParseMask',
    'SAFT12kHz8BitMono', 'SPSModifier', 'SRERecoOtherContext',
    'ISpEventSource', 'SPSEMANTICFORMAT', 'SPWORDLIST',
    'DISPID_SCSBaseStream', 'SPINTERFERENCE_TOOFAST',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SGRSTsItem',
    'ISpRecoResult', 'SVSFVoiceMask', 'DISPID_SpeechLexiconWords',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPEI_RECO_OTHER_CONTEXT',
    'eLEXTYPE_MORPHOLOGY', 'SPEI_RESERVED5', 'SVP_12',
    'SAFTGSM610_44kHzMono', 'SAFT44kHz16BitStereo',
    'DISPID_SLGetWords', 'DISPID_SLPSymbolic', 'DISPID_SMSALineId',
    'DISPID_SLGetPronunciations', 'SAFTADPCM_22kHzMono', 'SGRSTTRule',
    'SPPS_SuppressWord', 'DISPID_SLWPronunciations',
    '_ISpeechVoiceEvents', 'SPSUnknown', 'DISPID_SRRPhraseInfo',
    'SVEStartInputStream', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPIAudioStreamPosition', 'SPDKL_CurrentUser',
    'SpTextSelectionInformation', 'ISpeechPhraseElement',
    'SAFTADPCM_11kHzMono', 'DISPID_SRCEPropertyNumberChange',
    'DISPIDSPTSI_ActiveLength', 'SP_VISEME_4', 'eLEXTYPE_PRIVATE5',
    'SBOPause', 'SSTTDictation', 'DISPID_SVAlertBoundary',
    'SpStreamFormatConverter', 'DISPID_SPRuleChildren',
    'DISPID_SGRClear', 'SPFM_CREATE_ALWAYS', 'DISPID_SRCBookmark',
    'SpeechGrammarTagDictation', 'SGSEnabled',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SpeechLexiconWord',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SDKGetBinaryValue',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SVEWord',
    'SpeechRetainedAudioOptions', 'DISPID_SRGCommit',
    'DISPID_SpeechPhraseElement', 'eLEXTYPE_PRIVATE14',
    'DISPID_SpeechPhraseReplacements', 'SPPS_Function',
    'eLEXTYPE_LETTERTOSOUND', 'SPWORDPRONUNCIATIONLIST',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SGRAddState',
    'SRSEIsSpeaking', 'IEnumSpObjectTokens', 'DISPID_SGRSTNextState',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRCESoundStart',
    'DISPID_SVSInputWordLength', 'DISPID_SRRSpeakAudio',
    'DISPID_SRCEventInterests', 'DISPID_SPIEnginePrivateData',
    'SDTLexicalForm', 'ISpPhraseAlt', 'SVP_3', 'SpMMAudioEnum',
    'SpeechLoadOption', 'SWPKnownWordPronounceable', 'SRAExport',
    'SPEI_MIN_TTS', 'SVP_18', 'SGSExclusive', 'SPSVerb',
    'ISpRecoGrammar2', 'ISpObjectToken', 'ISpStreamFormatConverter',
    'DISPID_SWFEChannels', 'WAVEFORMATEX',
    'ISpeechRecoResultDispatch', 'DISPID_SFSClose',
    'SPEI_INTERFERENCE', 'SRARoot', 'SREStreamStart',
    'DISPID_SVSRunningState', 'SVP_10',
    'DISPID_SpeechRecognizerStatus', 'ISpeechAudioFormat',
    'SPAUDIOSTATUS', 'SPEI_MAX_SR', 'SpeechBookmarkOptions',
    'DISPID_SADefaultFormat', 'SPFILEMODE',
    'DISPID_SWFEBitsPerSample', 'SVP_5', 'SAFT16kHz16BitStereo',
    'SAFT16kHz8BitStereo', 'SAFT11kHz16BitMono', 'SpStream',
    'STSF_CommonAppData', 'DISPID_SRGCmdLoadFromObject',
    '_ISpeechRecoContextEvents', 'ISpeechVoice', 'SGRSTTWord',
    'SAFT22kHz16BitStereo', 'SVP_8', 'eLEXTYPE_PRIVATE13',
    'DISPIDSPTSI_SelectionOffset', 'SPAUDIOOPTIONS',
    'DISPID_SRGetFormat', 'eWORDTYPE_ADDED', 'eLEXTYPE_PRIVATE7',
    'SPWT_DISPLAY', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SPIGrammarId', 'ISpeechLexiconWords', 'SP_VISEME_16',
    'SRSActive', 'SREAdaptation', 'SPEI_SENTENCE_BOUNDARY',
    'SP_VISEME_19', 'SpeechStreamFileMode', 'DISPID_SVEVoiceChange',
    'SpObjectTokenCategory', 'DISPID_SRGIsPronounceable',
    'SpeechVoiceSkipTypeSentence', 'SVSFIsFilename',
    'DISPID_SDKCreateKey', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SGRsCommitAndSave', 'SAFTNoAssignedFormat',
    'DISPID_SpeechRecoResultTimes', 'SP_VISEME_1', 'DISPID_SGRsItem',
    'DISPID_SVIsUISupported', 'SP_VISEME_9', 'DISPID_SVEStreamStart',
    'DISPID_SABufferNotifySize', 'SP_VISEME_14',
    'DISPID_SOTs_NewEnum', 'ISpeechGrammarRuleState', 'SP_VISEME_18',
    'SPRST_INACTIVE_WITH_PURGE', 'SVEAudioLevel',
    'DISPID_SVSLastBookmarkId', 'DISPID_SpeechRecoResult2',
    'SpPhoneticAlphabetConverter', 'SPWORD', 'SPPS_RESERVED3',
    'SpeechCategoryAudioIn', 'SRERecognition',
    'DISPID_SOTCreateInstance', 'DISPID_SPARecoResult', 'SPPS_LMA',
    'DISPID_SOTCId', 'SGLexicalNoSpecialChars', 'SpInprocRecognizer',
    'eLEXTYPE_PRIVATE12', 'SAFTNonStandardFormat', 'SPEI_RESERVED3',
    'DISPID_SRCRetainedAudio', 'SPEVENT', 'SPINTERFERENCE_TOOQUIET',
    'SVP_16', 'DISPID_SRGCmdLoadFromResource', 'DISPID_SGRSTsCount',
    'DISPID_SRCEInterference', 'SVP_14', 'DISPID_SPIStartTime',
    'DISPID_SPEsItem', 'ISpeechRecoResultTimes', 'SPFM_NUM_MODES',
    'SPSERIALIZEDPHRASE', 'SPEI_RECOGNITION', 'eLEXTYPE_PRIVATE9',
    'SPPS_Noncontent', 'SPRST_ACTIVE', 'SAFT24kHz16BitStereo',
    'SPAS_RUN', 'DISPID_SASFreeBufferSpace', 'SPVOICESTATUS',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SBSWrite', 'SpVoice',
    'SPWAVEFORMATTYPE', 'DISPID_SDKSetBinaryValue',
    'SpeechInterference', 'SpeechPropertyNormalConfidenceThreshold',
    'SpeechAddRemoveWord', 'SPRS_INACTIVE', 'SPPS_NotOverriden',
    'DISPID_SABIEventBias', 'DISPID_SRCEEnginePrivate', 'SVEViseme',
    'DISPID_SGRId', 'SAFT11kHz16BitStereo', 'DISPID_SRRGetXMLResult',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRGetRecognizers',
    'SVEPhoneme', 'DISPID_SPRulesItem', 'SRTExtendableParse',
    'DISPID_SpeechDataKey', 'SpeechVisemeFeature', 'ISpRecognizer2',
    'DISPID_SPEAudioStreamOffset', 'SPAS_PAUSE',
    'DISPID_SRRTTickCount', 'DISPID_SPERetainedStreamOffset',
    'ISpMMSysAudio', 'SPRST_NUM_STATES', 'DISPID_SLWType',
    'SECFNoSpecialChars', 'ISpObjectWithToken', 'SpeechAudioVolume',
    'DISPID_SLGetGenerationChange', 'DISPID_SPISaveToMemory',
    'DISPID_SPPValue', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRGetPropertyNumber', 'DISPID_SPRsItem',
    'SGPronounciation', 'ISpeechRecoResult', 'SP_VISEME_12',
    'SP_VISEME_8', 'SRSInactive', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SpeechPhraseReplacement', 'ISpeechAudio',
    'SpPhoneConverter', 'SPVPRIORITY', 'eLEXTYPE_PRIVATE17',
    'DISPID_SVSyncronousSpeakTimeout', 'SPSEMANTICERRORINFO',
    'SPSHORTCUTTYPE', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SVESentenceBoundary', 'DISPID_SVSPhonemeId',
    'SPCT_SUB_DICTATION', 'SpeechCategoryRecoProfiles',
    'SDA_Consume_Leading_Spaces', 'eLEXTYPE_APP', 'tagSTATSTG',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechVoiceStatus',
    'SpeechRunState', 'DISPID_SOTGetDescription', 'SDTAlternates',
    'SRTEmulated', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRGDictationSetState', 'SAFT8kHz16BitMono',
    'DISPID_SRRTimes', 'DISPID_SOTsItem', 'SPEI_TTS_BOOKMARK',
    'SP_VISEME_21', 'eLEXTYPE_PRIVATE16', 'ISpeechPhraseInfo',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SRGReset', 'SGDSActive',
    'SVP_11', 'SPSNoun', 'SpeechCategoryRecognizers',
    'DISPID_SpeechPhraseProperties', 'DISPID_SPIRetainedSizeBytes',
    'SpeechAudioFormatGUIDWave', 'SDTPronunciation',
    'DISPID_SDKOpenKey', 'eLEXTYPE_PRIVATE11', 'SPBO_PAUSE',
    'SPDATAKEYLOCATION', 'SPSInterjection', 'SDTProperty',
    'SAFT32kHz8BitStereo', 'SREPrivate', 'SPAR_Low',
    'DISPID_SpeechXMLRecoResult',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'eLEXTYPE_RESERVED10',
    'SPDKL_DefaultLocation', 'SPSMF_SRGS_SAPIPROPERTIES',
    'IInternetSecurityManager', 'DISPID_SLWsCount',
    'SAFTADPCM_44kHzMono', 'SPBOOKMARKOPTIONS',
    'DISPID_SPIGetDisplayAttributes', 'ISpeechRecognizer',
    'SDTReplacement', 'SVSFParseSsml', 'SpeechGrammarWordType',
    'SP_VISEME_20', 'SPSERIALIZEDRESULT', 'DISPID_SPRFirstElement',
    'DISPID_SPEAudioSizeBytes', 'SPPROPERTYINFO',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRStatus',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPEDisplayText',
    'SECNormalConfidence', 'SPEI_PHONEME', 'SGSDisabled',
    'DISPID_SPACommit', 'DISPID_SGRInitialState', 'SpObjectToken',
    'SECLowConfidence', 'DISPID_SLPsItem',
    'SAFTCCITT_uLaw_8kHzStereo', 'eLEXTYPE_RESERVED7',
    'DISPID_SPELexicalForm', 'SAFTADPCM_44kHzStereo', 'SVF_None',
    'DISPID_SGRName', 'SSSPTRelativeToEnd', 'SPEI_TTS_AUDIO_LEVEL',
    'SAFT44kHz16BitMono', 'SDTAudio', 'DISPID_SBSFormat',
    'SAFT48kHz8BitStereo', 'DISPID_SASState',
    'DISPID_SVEventInterests', 'SAFT44kHz8BitMono',
    'SpeechTokenKeyFiles', 'DISPID_SPEDisplayAttributes',
    'SAFT24kHz16BitMono', 'DISPID_SRProfile', 'DISPID_SGRSTText',
    'ISpRecoCategory', 'SpeechWordPronounceable',
    'ISpeechObjectTokenCategory', 'SECFIgnoreCase',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRRAudio',
    'SAFTCCITT_ALaw_8kHzMono', 'SWTAdded', 'SPCS_ENABLED',
    'SpeechRegistryUserRoot', 'SPBO_NONE', 'DISPID_SOTCGetDataKey',
    'SAFT48kHz16BitStereo', 'SP_VISEME_5', 'SpeechVisemeType',
    'DISPID_SRRRecoContext', 'ISpeechWaveFormatEx',
    'ISpeechPhraseAlternate', 'ISpPhoneticAlphabetSelection',
    'DISPID_SRSClsidEngine', 'DISPID_SOTCategory',
    'SREFalseRecognition', 'SPTEXTSELECTIONINFO',
    'Speech_StreamPos_Asap', 'DISPID_SpeechPhoneConverter',
    'SWPUnknownWordPronounceable', 'DISPID_SMSSetData',
    '__MIDL_IWinTypes_0009', 'ISpAudio', 'SDKLLocalMachine',
    'ISpRecognizer3', 'DISPID_SRCCreateResultFromMemory',
    'ISpStreamFormat', 'eWORDTYPE_DELETED',
    'DISPID_SDKSetStringValue', 'SPLO_STATIC',
    'DISPID_SVGetAudioInputs', 'DISPID_SRCESoundEnd',
    'DISPID_SPRuleEngineConfidence', 'SSFMCreate', 'SPPHRASEELEMENT',
    'SDKLDefaultLocation', 'ISpeechGrammarRuleStateTransition',
    'SVP_7', 'DISPID_SPERetainedSizeBytes', 'SASRun',
    'DISPID_SRCERecognitionForOtherContext', 'SVSFParseSapi',
    'SASStop', 'DISPID_SVSkip', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SPCIdToPhone', 'SpeechStreamSeekPositionType',
    'SPEI_START_SR_STREAM', 'SAFT8kHz8BitStereo', 'SPSHT_EMAIL',
    'ISpeechRecoGrammar', 'DISPID_SVGetAudioOutputs',
    'DISPID_SpeechWaveFormatEx', 'ISpDataKey', 'DISPID_SRRAlternates',
    'SDKLCurrentUser', 'SPSLMA', 'IInternetSecurityMgrSite',
    'ISpVoice', 'DISPID_SPRuleFirstElement', 'SAFT8kHz8BitMono',
    'DISPID_SVSLastStreamNumberQueued', 'SPGS_DISABLED',
    'SpMMAudioIn', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechAllElements', 'STCInprocServer', 'SPDKL_CurrentConfig',
    'SVP_2', 'DISPID_SPRText', 'DISPID_SPPsCount', 'SPPS_RESERVED4',
    'SPWT_LEXICAL', 'DISPID_SRCVoicePurgeEvent',
    'SpeechGrammarTagWildcard', 'SpeechMicTraining', 'SINoise',
    'Speech_StreamPos_RealTime', 'DISPID_SOTCDefault',
    'ISpeechBaseStream', 'SFTSREngine', 'SVP_13', 'SGDisplay',
    'SPINTERFERENCE_TOOSLOW', 'STCAll', 'SPFM_CREATE',
    'DISPID_SVWaitUntilDone', 'DISPID_SGRSTPropertyName', 'SVP_9',
    'SAFT12kHz16BitStereo', 'DISPID_SVGetProfiles', 'SPRST_INACTIVE',
    'DISPID_SpeechPhraseRules', 'DISPID_SPPsItem',
    'SpCompressedLexicon', 'SPAR_Medium',
    'DISPID_SVSInputSentencePosition', 'SpeechGrammarState',
    'ISpEventSink', 'SP_VISEME_10', 'DISPID_SOTIsUISupported',
    'eLEXTYPE_PRIVATE6', 'ISpeechRecoResult2',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPERequiredConfidence', 'DISPID_SPILanguageId',
    'DISPID_SPPId', 'DISPID_SPRuleName', 'DISPID_SRSetPropertyNumber',
    'SVSFIsNotXML', 'DISPID_SGRsCount', 'DISPID_SGRSTPropertyId',
    'ISpeechPhraseProperties', 'SVSFPurgeBeforeSpeak',
    'DISPID_SLWsItem', '_SPAUDIOSTATE', 'SREAllEvents', 'SBONone',
    'SRADynamic', 'SPRECOGNIZERSTATUS', 'SPSMF_SAPI_PROPERTIES',
    'SpInProcRecoContext', 'SREInterference',
    'DISPID_SPPEngineConfidence', 'DISPID_SRState',
    'SPXMLRESULTOPTIONS', 'DISPID_SOTDataKey',
    'SREPropertyStringChange', 'DISPID_SVDisplayUI',
    'SAFT11kHz8BitStereo', 'SPPS_Modifier', 'SAFTText',
    'SpeechRuleAttributes', 'DISPID_SRCState', 'ISpeechMemoryStream',
    'SPEI_MIN_SR', 'SAFT8kHz16BitStereo', 'DISPID_SGRSRule',
    'SGDSActiveWithAutoPause', 'SGLexical', 'ISpRecognizer',
    'SGDSActiveUserDelimited', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPEAudioSizeTime', 'SSFMOpenReadWrite',
    'DISPID_SpeechVoiceStatus', 'SpeechCategoryAudioOut',
    'SpeechTokenIdUserLexicon', 'ISpSerializeState', 'SPINTERFERENCE',
    'SpPhraseInfoBuilder', 'DISPID_SRGDictationUnload',
    'SpSharedRecognizer', 'SAFT12kHz8BitStereo', 'SPPS_Verb',
    'SRSInactiveWithPurge', 'ISpeechPhraseRules', '_RemotableHandle',
    'eLEXTYPE_PRIVATE4', 'SPXRO_SML',
    'DISPID_SPANumberOfElementsInResult', 'SAFT22kHz8BitMono',
    'SAFTGSM610_8kHzMono', 'SAFTGSM610_11kHzMono', 'ISpNotifySource',
    'DISPID_SpeechPhraseRule', 'SPAO_NONE', 'SAFTADPCM_8kHzMono',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechPhraseProperty',
    'SPPS_Interjection', 'SECFDefault', 'DISPID_SRCEBookmark',
    'STSF_LocalAppData', 'DISPID_SpeechAudioFormat',
    'DISPID_SLRemovePronunciation', 'SPCT_SLEEP', 'SPEI_VISEME',
    'DISPID_SPIGetText', 'SPWORDPRONUNCIATION', 'SVEPrivate',
    'DISPID_SLGenerationId', 'SPEVENTSOURCEINFO',
    'SAFT32kHz16BitMono', 'SPWORDTYPE', 'DISPID_SWFEExtraData',
    'SpWaveFormatEx', 'ISpeechPhraseReplacement',
    'DISPID_SRSCurrentStreamPosition', 'SITooSlow', 'SREStreamEnd',
    'DISPID_SRIsShared', 'DISPID_SRGetPropertyString',
    'SpeechRecoProfileProperties', 'SPWF_INPUT', 'DISPID_SVSpeak',
    'DISPID_SRGDictationLoad', 'DISPID_SVEBookmark',
    'DISPID_SVSVisemeId', 'SP_VISEME_11', 'SLTApp', 'DISPID_SRCVoice',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SPCPhoneToId',
    'DISPIDSPTSI_SelectionLength', 'SPVISEMES',
    'SAFTCCITT_ALaw_22kHzMono', 'SDKLCurrentConfig', 'SpCustomStream',
    'SP_VISEME_15', 'SAFTTrueSpeech_8kHz1BitMono', 'SRTStandard',
    'SPEI_WORD_BOUNDARY', 'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE3',
    'DISPID_SpeechFileStream', 'ISpProperties', 'SVSFPersistXML',
    'SPPARTOFSPEECH', 'DISPID_SPAsItem',
    'DISPID_SOTMatchesAttributes', 'DISPID_SVGetVoices',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SGRsCommit',
    'SWPUnknownWordUnpronounceable', 'SAFT22kHz8BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SRTSMLTimeout',
    'SpeechDisplayAttributes', 'SPGS_ENABLED', 'SpeechWordType',
    'SPDKL_LocalMachine', 'SITooLoud', 'SPSHORTCUTPAIR',
    'DISPID_SGRSTPropertyValue', 'DISPID_SpeechBaseStream',
    'SPINTERFERENCE_TOOLOUD', 'STCRemoteServer',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechLexicon',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFTCCITT_uLaw_22kHzMono',
    'SpeechAudioFormatGUIDText', 'SASPause',
    'SPINTERFERENCE_NOSIGNAL', 'SRESoundStart', 'DISPID_SRGId',
    'SpLexicon', 'DISPID_SGRSTType', 'SPSNotOverriden',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechRecoResult',
    'SRADefaultToActive', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechPhraseProperty', 'SpeechPropertyResourceUsage',
    ...
    'ISpObjectTokenCategory', 'eLEXTYPE_USER', 'DISPID_SLWLangId',
    'SpeechFormatType', 'SPEI_ADAPTATION',
    'ISpeechPhraseReplacements', 'SPEI_MAX_TTS', 'SpeechTokenContext',
    'ISpeechDataKey', 'SVP_6', 'DISPID_SRRecognizer', 'SASClosed',
    'DISPID_SLPPhoneIds', 'SpNullPhoneConverter',
    'DISPID_SRGCmdSetRuleState', 'SPEI_UNDEFINED',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SLPsCount', 'DISPID_SAFGuid',
    'ISpeechRecognizerStatus', 'SAFTADPCM_8kHzStereo', 'SVP_21',
    'DISPID_SRGRecoContext', 'SVSFUnusedFlags', 'SAFT12kHz16BitMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPEI_PHRASE_START',
    'DISPID_SWFEFormatTag', 'DISPID_SPIReplacements',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechCustomStream',
    'DISPID_SPPName', 'DISPID_SRCreateRecoContext', 'DISPID_SAVolume',
    'SpAudioFormat', 'SGRSTTTextBuffer', 'DISPID_SMSADeviceId',
    'SRAONone', 'DISPID_SRGSetWordSequenceData', 'SECFEmulateResult',
    'SPADAPTATIONRELEVANCE', 'eLEXTYPE_RESERVED6', 'DISPID_SRGRules',
    'DISPID_SGRSAddWordTransition', 'ISpeechPhraseElements',
    'SVEBookmark', 'DISPID_SABufferInfo', 'ISpeechResourceLoader',
    'SAFTCCITT_uLaw_22kHzStereo', 'SINoSignal', 'SPPS_Unknown',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPRuleParent',
    'DISPID_SPCLangId', 'SPEI_END_SR_STREAM', 'SPLOADOPTIONS',
    'SVEWordBoundary', 'SSFMOpenForRead', 'SVESentenceBoundary',
    'DISPID_SpeechObjectToken', 'DISPID_SLPLangId',
    'SAFTCCITT_uLaw_44kHzMono', 'SECHighConfidence',
    'DISPID_SVSLastBookmark', 'SREHypothesis', 'SPPHRASE',
    'ISpNotifyTranslator', 'SpFileStream', 'DISPID_SPEsCount',
    'SDTAll', 'DISPID_SpeechObjectTokens', 'DISPID_SDKDeleteKey',
    'SpeechTokenValueCLSID', 'SAFTDefault',
    'DISPID_SRAudioInputStream', 'SVEAllEvents',
    'DISPID_SPRs_NewEnum', 'SVP_4', 'DISPID_SRSAudioStatus',
    'ISpeechObjectToken', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SOTCEnumerateTokens',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVP_19', 'SPEVENTENUM',
    'DISPID_SRCEStartStream', 'DISPID_SpeechGrammarRule',
    'DISPID_SPAStartElementInResult', 'SAFT32kHz8BitMono',
    'ISpeechLexiconPronunciation', 'SpeechCategoryPhoneConverters',
    'DISPID_SRCSetAdaptationData', 'DISPID_SpeechRecoContext',
    'SPCATEGORYTYPE', 'DISPID_SGRs_NewEnum',
    'DISPID_SVEEnginePrivate', 'SITooQuiet', 'SAFT32kHz16BitStereo',
    'SSTTWildcard', 'DISPID_SpeechGrammarRuleStateTransitions',
    'eLEXTYPE_PRIVATE8', 'DISPID_SPIProperties', 'ISpeechAudioStatus',
    'SpSharedRecoContext', 'SPEI_TTS_PRIVATE',
    'SpeechPropertyAdaptationOn', 'DISPID_SPRuleNumberOfElements',
    'SPCS_DISABLED', 'DISPID_SPEEngineConfidence', 'DISPID_SVStatus',
    'SPAO_RETAIN_AUDIO', 'DISPID_SABIBufferSize', 'SGRSTTWildcard',
    'eLEXTYPE_PRIVATE20', 'DISPID_SPEPronunciation', 'STCLocalServer',
    'DISPID_SPIAudioSizeTime', 'ISpLexicon', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRCAudioInInterferenceStatus',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVF_Stressed',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechCustomStream',
    'SDA_One_Trailing_Space', 'SpeechEngineProperties', 'SVPAlert',
    'SRAInterpreter', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SAEventHandle', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRCEPhraseStart', 'ISpeechTextSelectionInformation',
    'DISPID_SRGSetTextSelection', 'SpeechEngineConfidence',
    'DISPID_SOTSetId', 'SpeechVoiceEvents', 'SAFT16kHz8BitMono',
    'SpeechVoicePriority', 'DISPID_SGRSTWeight', 'SpeechDiscardType',
    'eLEXTYPE_PRIVATE18', 'SPXRO_Alternates_SML', 'SITooFast',
    'DISPID_SpeechPhraseBuilder', 'SPSHT_NotOverriden',
    'SDA_No_Trailing_Space',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSpeakStream', 'SECFIgnoreWidth', 'SVPNormal',
    'DISPID_SWFESamplesPerSec', 'SpeechPropertyResponseSpeed',
    'DISPID_SVEPhoneme', 'eLEXTYPE_PRIVATE2', 'DISPID_SPPChildren',
    'DISPID_SPRDisplayAttributes', 'SpeechRecognizerState',
    'STCInprocHandler', 'ISpXMLRecoResult', 'DISPID_SRCPause',
    'DISPID_SPEAudioTimeOffset', 'ISpeechPhraseRule',
    'SVEEndInputStream', 'STSF_AppData',
    'SpeechSpecialTransitionType', 'SAFT44kHz8BitStereo',
    'DISPID_SPRulesCount', 'SAFT48kHz16BitMono',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRIsUISupported',
    'DISPID_SRSCurrentStreamNumber', 'SDA_Two_Trailing_Spaces',
    'DISPID_SASetState', 'SPEI_RESERVED2', 'DISPID_SPAPhraseInfo',
    'SPEI_SOUND_START', 'SPEI_FALSE_RECOGNITION', 'SPAUDIOSTATE',
    'IEnumString', 'DISPID_SRRSetTextFeedback',
    'Speech_Max_Word_Length', 'SpeechGrammarTagUnlimitedDictation',
    'tagSPPROPERTYINFO', 'SPWORDPRONOUNCEABLE',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SLWs_NewEnum',
    'DISPID_SRGState', 'ISpRecoContext', 'DISPID_SPRNumberOfElements',
    'DISPID_SGRSTs_NewEnum', 'ISpResourceManager',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SMSAMMHandle',
    'SVSFlagsAsync', 'SSSPTRelativeToCurrentPosition',
    'Speech_Default_Weight', 'ISequentialStream', 'SPPS_RESERVED1',
    'SPWF_SRENGINE', 'DISPID_SpeechVoiceEvent', 'ISpNotifySink',
    'ISpeechLexiconWord', 'LONG_PTR', 'SPGRAMMARWORDTYPE',
    'DISPID_SRRSaveToMemory', 'SPRULESTATE',
    'DISPID_SPEActualConfidence', 'DISPIDSPTSI',
    'DISPID_SRSNumberOfActiveRules', 'SPSTREAMFORMATTYPE',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SOTGetAttribute', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SpeechAudioStatus', 'DISPID_SGRSTransitions',
    'SpeechUserTraining', 'eLEXTYPE_RESERVED8', 'SPCT_SUB_COMMAND',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPAsCount', 'DISPID_SLPType',
    'DISPID_SRCEEndStream', 'SRTReSent', 'SpeechRuleState',
    'DISPID_SRCERequestUI', 'DISPID_SGRsAdd', 'SpMemoryStream',
    'SRCS_Disabled', 'SVEVoiceChange', 'SpeechRecoContextState',
    'DISPID_SOTId', 'DISPID_SOTRemove', 'SVP_20', 'DISPID_SBSRead',
    'DISPID_SVEAudioLevel', 'SPEI_HYPOTHESIS',
    'ISpeechPhraseAlternates', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRCRetainedAudioFormat', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRCRequestedUIType', 'eLEXTYPE_PRIVATE10',
    'DISPID_SpeechPhraseElements', 'DISPID_SPRuleConfidence',
    'DISPID_SMSGetData', 'DISPID_SpeechRecoContextEvents',
    'SAFT11kHz8BitMono', 'SINone',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SGRsDynamic',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SFSOpen',
    'ISpPhoneConverter', 'SVP_17', 'SpeechVoiceCategoryTTSRate',
    'SpeechLexiconType', 'SPEI_SR_BOOKMARK', 'SPVPRI_ALERT', 'SVP_1',
    'SDTDisplayText', 'SVSFNLPSpeakPunc', 'SSTTTextBuffer',
    'ISpeechAudioBufferInfo', 'DISPID_SPEs_NewEnum', 'DISPID_SPIRule',
    'SGDSInactive', 'SPINTERFERENCE_NONE', 'DISPID_SVVoice',
    'DISPIDSPTSI_ActiveOffset', 'SpeechCategoryAppLexicons',
    'DISPID_SOTCSetId', 'SAFTGSM610_22kHzMono', 'SPBO_TIME_UNITS',
    'DISPID_SDKDeleteValue', 'UINT_PTR', 'SRESoundEnd',
    'SPCT_COMMAND', 'SGRSTTEpsilon', 'DISPID_SABIMinNotification',
    'SPLEXICONTYPE', 'SPAR_High', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SVPriority', 'SPGRAMMARSTATE', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SVAudioOutput', 'ISpeechGrammarRule',
    'SpeechEmulationCompareFlags', 'ISpRecoGrammar',
    'SpeechTokenKeyUI', 'SPPHRASEREPLACEMENT', 'SPSMF_UPS',
    'DISPID_SGRAddResource', 'SpeechAudioFormatType',
    'ISpeechGrammarRules', 'DISPID_SREmulateRecognition',
    'SSFMCreateForWrite', 'DISPID_SLPs_NewEnum', 'DISPID_SRCResume',
    'SPEI_END_INPUT_STREAM', 'SPEI_VOICE_CHANGE', 'DISPID_SPPParent',
    'SRCS_Enabled', 'SRATopLevel', 'DISPID_SAFType',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_RESERVED1', 'SVP_15',
    'DISPID_SDKGetStringValue', 'DISPID_SpeechVoice',
    'DISPID_SDKGetlongValue', 'SECFIgnoreKanaType',
    'SREPropertyNumChange', 'ISpeechRecoContext',
    'DISPID_SVAudioOutputStream', 'SP_VISEME_0', 'SP_VISEME_6',
    'SP_VISEME_13', 'DISPID_SpeechGrammarRules', 'DISPID_SPRsCount',
    'SRTAutopause', 'SGRSTTDictation', 'SPCONTEXTSTATE',
    'ISpGrammarBuilder', 'DISPID_SPPConfidence',
    'SPRST_ACTIVE_ALWAYS', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpeechObjectTokens', 'SAFT24kHz8BitMono',
    'SAFTADPCM_22kHzStereo', 'SVSFDefault', 'DISPID_SASNonBlockingIO',
    'DISPID_SPAs_NewEnum', 'DISPID_SGRAttributes', 'SPEI_SR_PRIVATE',
    'SRERequestUI', 'eLEXTYPE_RESERVED9'
]

_check_version('1.2.0', 1617976545.961285)
